...
var Dashboard = function () {
		...
		_createClass(Dashboard, [{
				key: "findLastUpdateImages",
				value: function findLastUpdateImages() {
				...
				key: "lastCompanyProjectsPKs",
				value: function lastCompanyProjectsPKs(callback, error) {

						$.when(marvelGraphQL.companyProjects()).then(function (projectJson) {
				...
				key: "findImagesForProjectsWithPk",
				value: function findImagesForProjectsWithPk(PKs, callback) {
						...
						$.each(PKs, function (i, pk) {
								...
								deferreds.push(marvelGraphQL.project(pk).then(function (result) {
...
var MarvelGraphQL = function () {
  function MarvelGraphQL(clientId, scopes) {
    _classCallCheck(this, MarvelGraphQL);
  ...
  _createClass(MarvelGraphQL, [{
    ...
    key: "companyProjects",
    value: function companyProjects() {
    ...
    value: function personalProjects() {
